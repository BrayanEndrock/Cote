                ...
                function GoCart(t) {
                    ...
                    (this.defaults = Object.assign(
                        {},
                        {
                            ...
                            afterPayDrawerSubTotal: ".afterpay-placement",
                        ...
                        (this.afterPayDrawerSubTotal = document.querySelector(this.defaults.afterPayDrawerSubTotal)),
                    ...
                    (e = [
                        {
                            ...
                            value: function () {
                                ...
                                this.fetchCart(),
                                    ...
                                    this.cartTrigger.forEach(function (e) {
                            ...
                            value: function (t) {
                                ...
                                this.clearCartDrawer(),
                                    t.items.forEach(function (t, r) {
                                        ...
                                        console.log(t.options_with_values[0].name);
                                        null === a && (a = "");
                                        let lineItem = Number(r + 1);
                                        let priceItem = formatMoney(t.line_price, e.moneyFormat);
                                        var o = `<div class="go-cart-item__single" data-line="${lineItem}">
                                        <div class="go-cart-item__info-wrapper">
                                            ...
                                            <div class="go-cart-item__info">
                                                ...
                                                <div class="go-cart-item__price">${priceItem}</div>
                                                <div class="go-cart-item__variant">${a}</div>
                                                <div class="quantity_and_price">
                                                    <div class="go-cart-item__quantity">
                                                        <span class="go-cart-item__quantity-label">${e.labelQuantity}</span>
                                                        <span class="go-cart-item__quantity-button js-go-cart-quantity-minus" data-line="${lineItem}">-</span>
                                                        <input class="go-cart-item__quantity-number js-go-cart-quantity" type="number" data-line="${lineItem}" value="${t.quantity}" disabled="">
                                                        <span class="go-cart-item__quantity-button js-go-cart-quantity-plus" data-line="${lineItem}">+</span>
                                                        <span class="label-quantity">Qty. ${t.quantity}</span>
                                                        <span class="separator">|</span>
                                                        <a class="btn btn-primary small go-cart-item__remove ${e.removeFromCartNoDot}" data-line="${lineItem}">${e.labelRemove}</a>
                                                    </div>
                                                </div>
                                    ...
                                    (this.cartDrawerSubTotal.innerHTML = formatMoney(t.total_price, this.moneyFormat)),
                                    (this.afterPayDrawerSubTotal.setAttribute('data-amount', (t.total_price/100))),
                                    ...
                                    document.querySelectorAll(this.removeFromCart).forEach(function (t) {
                                        t.addEventListener("click", function () {
                                            ...
                                            var r = t.getAttribute("data-line");
                                            e.removeItem(r);
                                ...
                                this.clearMiniCart(),
                                    t.items.forEach(function (t, r) {
                                        ...
                                        var o = '\n        <div class="go-cart-item__single" data-line="'
                                            ...
                                            .concat(formatMoney(t.line_price, e.moneyFormat), '</div>\n            <a class="go-cart-item__remove ')
                                            .concat(e.removeFromCartNoDot, '">')
                                            .concat(e.labelRemove, "</a>\n        </div>\n      ");
                                        e.cartMiniCartContent.innerHTML += o;
                                    }),
                                    (this.cartMiniCartSubTotal.innerHTML = formatMoney(t.total_price, this.moneyFormat)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.cartDrawer.classList.remove("abandon-drawer");
